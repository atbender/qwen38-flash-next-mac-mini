...
BG='#0b1118';PANEL='#121d28';BORDER='#263444';WHITE='#edf4fa';MUTED='#91a4b8';CYAN='#6ee7da';GOLD='#f0c56a'
...
def render(t,data,speed):
 ...
 text(40,28,'LOCAL INFERENCE / MEASURED TOKEN REPLAY',15,CYAN,True)
 ...
 box(40,432,1360,384);text(60,448,'MODEL OUTPUT',14,MUTED,True);text(1185,448,f'{idx+1} / {len(ev)} tokens',17,CYAN)
 ...
 box(40,836,440,100);text(60,851,'PROCESS MEMORY · RUN PEAK',14,MUTED,True);text(60,879,f'{data["peak_process_gb"]:.2f} GB',30,CYAN,True)
 box(500,836,440,100);text(520,851,'EXPERT CACHE · DECODE HIT RATE',14,MUTED,True);text(520,879,f'{data["expert_cache_hit_rate"]*100:.1f}%',30,CYAN,True)
